---
layout:     post
title:      云原生开源工具_软件_教程大全
subtitle:   A curated list of open-source cloud native tools, software, and tutorials.
date:       2023-06-29
author:     YF
header-img: img/in-post/vvsun_A_beautiful_artistic_digital_painting_The_astronaut_in_a__8aa056da-cf8f-4a20-8184-979fa306144a.png
catalog: true
tags:
    - Midjourney
    - AI
...
> 云原生是一种行为和设计理念。本质上，任何能够提高云资源利用率和应用程序交付效率的行为或方法都被称为云原生。
...
This website is clone within [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) repository.
