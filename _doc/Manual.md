...
```yml
# Site settings
title: vvsun Blog             # title of your website
SEOTitle: vvsun Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: vvsun     # modify this account to yours
weibo_username: vvsun      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-vvsun.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“vvsun Blog”** but I want the title shows in search engine is **“黄玄的博客 | vvsun Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/vvsun/vvsun.github.io/issues/15) about code wrap.
