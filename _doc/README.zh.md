...
# SNS settings      
github_username: vvsun     # 你的github账号
weibo_username: vvsun      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-vvsun.jpg     #你的大头贴，请使用绝对地址.
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/vvsun/vvsun.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
这个SEO Title就是定义了<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。
